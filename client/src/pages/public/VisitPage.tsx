          ...
          <form onSubmit={submit} noValidate className="card space-y-7 p-5 sm:p-8">
            ...
            <fieldset disabled={!readiness.ready} className="space-y-7">
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <Select label="التخصص" name="specialty" required value={values.specialty} onChange={(e) => set('specialty', e.target.value)} error={errors.specialty} placeholder="اختاري التخصص" options={config?.lists.specialties ?? []} />
              </div>
