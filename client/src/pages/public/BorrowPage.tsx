      ...
      <div className="mx-auto max-w-2xl space-y-4">
        ...
        <div className="card animate-scale-in p-8 text-center" role="status">
          ...
          <p className="mt-2 text-ink-600">
            وصل طلبك لاستعارة كتاب «{b.title}» إلى المكتبة. احفظي الرمز المرجعي لمراجعة الطلب عند الاستلام.
          </p>
          {ref}
          <div className="mt-6 flex flex-wrap justify-center gap-3">
    ...
    <div className="grid items-start gap-6 lg:grid-cols-[20rem_1fr]">
      ...
      <form className="card space-y-6 p-5 sm:p-7" onSubmit={submit} noValidate>
        <div>
          ...
          <p className="mt-1 text-sm text-ink-600">الاسم والرقم التدريبي فقط، واسم الكتاب يُعبأ تلقائيًا من الكتاب المختار.</p>
        </div>
        ...
        <fieldset className="space-y-4" disabled>
          <legend className="mb-3 text-sm font-bold text-teal-700">الكتاب المطلوب</legend>
          <div className="grid gap-4 sm:grid-cols-2">
