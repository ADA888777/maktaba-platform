...
export const booksRepo = createCrudRepository<Book, BookInput>({
  ...
  sorts: { newest: 'books.created_at DESC', title: 'books.title COLLATE NOCASE ASC' },
...
export const resourcesRepo = createCrudRepository<ElectronicResource, ResourceInput>({
  ...
  sorts: { newest: 'electronic_resources.created_at DESC', name: 'electronic_resources.name COLLATE NOCASE ASC' },
...
export const projectsRepo = createCrudRepository<Project, ProjectInput>({
  ...
  sorts: { newest: 'projects.project_date DESC, projects.id DESC', title: 'projects.title COLLATE NOCASE ASC' },
  defaultSort: 'projects.project_date DESC, projects.id DESC',
